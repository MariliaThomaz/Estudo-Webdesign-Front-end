; (function () {
    ...
    function Task(name, completed = false, createdAt = Date.now(), updatedAt = null) {
        ...
        //this.name = name
        // para proteger a propriedade name, podemos usar uma variável local (let _name) e criar um método getName para acessar o valor de name.
        let _name = name
        ...
        this.setName = function (newName) {
            _name = newName
            this.updatedAt = Date.now()
            console.log(`O nome da tarefa foi atualizado para: ${_name}`)
        }
    }
